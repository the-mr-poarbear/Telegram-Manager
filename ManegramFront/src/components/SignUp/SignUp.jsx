...
function SignUp(){
    ...
    function RegisterCheck(refs){
        console.log(refs)
        axios.post('http://127.0.0.1:8000/register',{username : refs[0].current.value ,password : refs[1].current.value ,firstname : refs[2].current.value ,lastname : refs[3].current.value , } ).then((response) =>{
