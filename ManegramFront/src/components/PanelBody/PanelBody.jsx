...
function PanelBody(){
    ...
    useEffect(()=>{
        axios.get('http://127.0.0.1:8000/admin-management-container/'+ selected.container_id ,{headers: {'Authorization': `bearer ${localStorage.getItem('accsess_token')}`}  } ).then((response)=>{
